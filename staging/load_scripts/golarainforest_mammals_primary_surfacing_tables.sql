...
-- golarainforest_mammals_primary with dataset id (table name) e.g 'gorongosa_flora'
...
values (
	'golarainforest_mammals_primary', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'golarainforest_mammals_primary', --table_name: the name of the table that holds the species list. note same as dataset_id
...
--delete from feature_metadata where data_table = 'golarainforest_mammals_primary' and title = 'Species name'

--Species Name field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
	'golarainforest_mammals_primary', --data_table - the name of the species list table. should match data_registry.table_name
...
-- delete from feature_metadata where data_table = 'golarainforest_mammals_primary' and title = 'Source'
-- Source field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
	'golarainforest_mammals_primary', --data_table - the name of the species list table. should match data_registry.table_name
	'''A Preliminary Survey of Small Terrestrial Mammals in the Gola Forest, Sierra Leone (Primary Source)''', --field - the name of the field to be displayed from the data_table
		
	-- do not change fields below this line
	'Source', -- title - the display name of the field
	2 --order - how to order the fields from the data_table
)
-- delete from feature_metadata where data_table = 'golarainforest_mammals_primary' and title = 'Provider'
-- Provider field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'golarainforest_mammals_primary' and title = 'URL'
-- URL field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- dashboard_metadata
--delete from dashboard_metadata where dataset_id = 'golarainforest_mammals_primary'
...
values (
	...
	'golarainforest_mammals_primary', --dataset_id - the name of the species list table
	null, --  with null if not applicable
	'ca. 2008', --ca. 2008 with a string representation for the date range "ca. 1980 to 2010"
	'A Preliminary Survey of Small Terrestrial Mammals in the Gola Forest, Sierra Leone (Primary Source)', --description - string description
