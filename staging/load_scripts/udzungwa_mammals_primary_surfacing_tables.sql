...
-- udzungwa_mammals_primary with dataset id (table name) e.g 'gorongosa_flora'
...
values (
	'udzungwa_mammals_primary', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'udzungwa_mammals_primary', --table_name: the name of the table that holds the species list. note same as dataset_id
	'udzungwa_mammals_primary_geom', --geom_table: the name of the geom table.  should be <table_name>_geom eg "myanmar_flora_geom"	
...
--delete from feature_metadata where data_table = 'udzungwa_mammals_primary' and title = 'Species name'

--Species Name field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
	'udzungwa_mammals_primary', --data_table - the name of the species list table. should match data_registry.table_name
...
-- delete from feature_metadata where data_table = 'udzungwa_mammals_primary' and title = 'Source'
-- Source field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'udzungwa_mammals_primary' and title = 'Provider'
-- Provider field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'udzungwa_mammals_primary' and title = 'URL'
-- URL field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- dashboard_metadata
--delete from dashboard_metadata where dataset_id = 'udzungwa_mammals_primary'
...
values (
	...
	'udzungwa_mammals_primary', --dataset_id - the name of the species list table
