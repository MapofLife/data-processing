...
-- lormagolagrebo_birds with dataset id (table name) e.g 'gorongosa_flora'
...
-- Birds - same as class but with common names "Plants", or "Birds"
...
values (
	'lormagolagrebo_birds', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'lormagolagrebo_birds', --table_name: the name of the table that holds the species list. note same as dataset_id
...
--delete from feature_metadata where data_table = 'lormagolagrebo_birds' and title = 'Species name'

--Species Name field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
	'lormagolagrebo_birds', --data_table - the name of the species list table. should match data_registry.table_name
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_birds' and title = 'Source'
-- Source field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_birds' and title = 'Provider'
-- Provider field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_birds' and title = 'URL'
-- URL field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- dashboard_metadata
--delete from dashboard_metadata where dataset_id = 'lormagolagrebo_birds'
...
values (
	...
	'lormagolagrebo_birds', --dataset_id - the name of the species list table
	...
	'Birds', -- Birds - same as class but with common names "Plants", or "Birds"
