...
-- lormagolagrebo_bats with dataset id (table name) e.g 'gorongosa_flora'
...
-- bats with the lower-case tax. e.g. herps or aves
-- Bats with the same as taxa column, but capitalize
...
--  - same as class but with common names "Plants", or "Birds"
-- Bats with references for the taxonomy
...
values (
	'lormagolagrebo_bats', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'lormagolagrebo_bats', --table_name: the name of the table that holds the species list. note same as dataset_id
	...
	'bats', --taxa: the taxonomic group, like "plants", "aves", herps, etc.  should match dashboard_metadata.class	
	'Bats', -- classes: same as taxa column, but capitalize
...
--delete from feature_metadata where data_table = 'lormagolagrebo_bats' and title = 'Species name'

--Species Name field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
	'lormagolagrebo_bats', --data_table - the name of the species list table. should match data_registry.table_name
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_bats' and title = 'Source'
-- Source field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_bats' and title = 'Provider'
-- Provider field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_bats' and title = 'URL'
-- URL field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- dashboard_metadata
--delete from dashboard_metadata where dataset_id = 'lormagolagrebo_bats'
...
values (
	'bats', --class - the taxonomic group, like "plants" or "aves".  should match data_registry.taxa
	'hoke', --provider
	...
	'lormagolagrebo_bats', --dataset_id - the name of the species list table
	...
	null, --  - same as class but with common names "Plants", or "Birds"
	'Bats', --taxonomy_metadata: references for the taxonomy
