...
SELECT * FROM get_tile('barata', 'localinv', 'Afrixalus aureus','morocco_east_herps')
...
select * from morocco_east_herps where scientificname = 'Afrixalus aureus';	
