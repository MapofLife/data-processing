...
values (
	...
	'2010', -- pubdate: year published
	'Annotated checklist of the birds of Banhine National Park, Southern Mozambique', -- title: String title I.e. "Birds of Melanesia". should mach data_registry.dataset_title and dashboard.dataset_title
	'http://oo.adu.org.za/content.php?id=4', --url: Link to the study
...
values (
	'banhine_birds', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'banhine_birds', --table_name: the name of the table that holds the species list. note same as dataset_id
	'banhine_birds_geom', --geom_table: the name of the geom table.  should be <table_name>_geom eg "myanmar_flora_geom"	
	...
	'Annotated checklist of the birds of Banhine National Park, Southern Mozambique', --dataset_title - the publication name.  "Birds of Melanesia" should match providers.title and dashboard dataset.title
...
--delete from feature_metadata where data_table = 'banhine_birds' and title = 'Species name'

--Species Name field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'banhine_birds', --data_table - the name of the species list table. should match data_registry.table_name
...
-- delete from feature_metadata where data_table = 'banhine_birds' and title = 'Source'
-- Source field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'banhine_birds', --data_table - the name of the species list table. should match data_registry.table_name
	'pietersen', --provider - the id of the provider.  should match providers.provider
	'''Annotated checklist of the birds of Banhine National Park, Southern Mozambique''', --field - the name of the field to be displayed from the data_table
...
-- delete from feature_metadata where data_table = 'banhine_birds' and title = 'Provider'
-- Provider field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'banhine_birds', --data_table - the name of the species list table. should match data_registry.table_name
	'pietersen', --provider - the id of the provider.  should match providers.provider
	'''Pietersen, 2010''', --field - the name of the field to be displayed from the data_table
...
-- delete from feature_metadata where data_table = 'banhine_birds' and title = 'URL'
-- URL field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'banhine_birds', --data_table - the name of the species list table. should match data_registry.table_name
	'pietersen', --provider - the id of the provider.  should match providers.provider
	'''<a target=''''_blank'''' onclick=''''window.open(this.href)'''' href=''''http://oo.adu.org.za/content.php?id=4''''>oo.adu.org.za</a>''', --field - the name of the field to be displayed from the data_table
...
-- delete from feature_metadata where data_table = 'banhine_birds' and title = 'Type'
...
-- dashboard_metadata
--delete from dashboard_metadata where dataset_id = 'banhine_birds'
...
values (
	...
	'banhine_birds', --dataset_id - the name of the species list table
	...
	'Annotated checklist of the birds of Banhine National Park, Southern Mozambique', --description - string description
	'Pietersen DW, Pietersen EW 2010. Annotated checklist of the birds of Banhine National Park, Southern Mozambique.  Ornithologal Observations 1:7-37', --recommended_citation 
	...
	'Aves', -- taxon - same as class but with common names "Plants", or "Birds"
	null, --taxonomy_metadata: references for the taxonomy
	'http://oo.adu.org.za/content.php?id=4', --url - url of the datasource
