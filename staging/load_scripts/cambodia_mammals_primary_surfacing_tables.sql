...
values (
	'cambodia_mammals_primary', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'cambodia_mammals_primary', --table_name: the name of the table that holds the species list. note same as dataset_id
	'cambodia_mammals_primary_geom', --geom_table: the name of the geom table.  should be <table_name>_geom eg "myanmar_flora_geom"	
...
values (
	'cambodia_mammals_primary', --data_table - the name of the species list table. should match data_registry.table_name
...
values (
	...
	'cambodia_mammals_primary', --dataset_id - the name of the species list table
