...
-- lormagolagrebo_amphibians with dataset id (table name) e.g 'gorongosa_flora'
...
-- amphibians with the lower-case tax. e.g. amphibians or aves
...
values (
	'lormagolagrebo_amphibians', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'lormagolagrebo_amphibians', --table_name: the name of the table that holds the species list. note same as dataset_id
	...
	'amphibians', --taxa: the taxonomic group, like "plants", "aves", amphibians, etc.  should match dashboard_metadata.class	
...
--delete from feature_metadata where data_table = 'lormagolagrebo_amphibians' and title = 'Species name'

--Species Name field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
	'lormagolagrebo_amphibians', --data_table - the name of the species list table. should match data_registry.table_name
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_amphibians' and title = 'Source'
-- Source field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_amphibians' and title = 'Provider'
-- Provider field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- delete from feature_metadata where data_table = 'lormagolagrebo_amphibians' and title = 'URL'
-- URL field
insert into feature_metadata
	(data_table,field,title,"order") --order and type are keywords so need to be in quotes
values (
...
-- dashboard_metadata
--delete from dashboard_metadata where dataset_id = 'lormagolagrebo_amphibians'
...
values (
	...
	'lormagolagrebo_amphibians', --dataset_id - the name of the species list table
	...
	'Amphibians', -- Amphibians and Reptiles - same as class but with common names "Plants", or "Birds"
