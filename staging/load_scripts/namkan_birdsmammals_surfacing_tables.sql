...
-- A survey of gibbons and other wildlife in the Bokeo section of Nam Kan National Protected Area, Lao PDR with title e.g. 'Tinleys plant species list for the greater Gorongosa ecosystem'
-- namkan_birdsmammals with dataset id (table name) e.g 'gorongosa_flora'
-- 2013 with year of publication e.g. '2010' 
-- http://www.fauna-flora.org/wp-content/uploads/Nam-Kan-Gibbon-Survey-2012-18-May-2013.pdf with the full url to the study e.g. http://oo.adu.org.za/content.php?id=4
-- aves and mammals with the lower-case tax. e.g. herps or aves
...
values (
	...
	'A survey of gibbons and other wildlife in the Bokeo section of Nam Kan National Protected Area, Lao PDR', -- title: String title I.e. "Birds of Melanesia". should mach data_registry.dataset_title and dashboard.dataset_title
	'http://www.fauna-flora.org/wp-content/uploads/Nam-Kan-Gibbon-Survey-2012-18-May-2013.pdf', --url: Link to the study
...
values (
	'namkan_birdsmammals', --dataset_id: the name of the species list table (same as table_name) e.g. "myanmar_flora"
	'namkan_birdsmammals', --table_name: the name of the table that holds the species list. note same as dataset_id
	'namkan_birdsmammals_geom', --geom_table: the name of the geom table.  should be <table_name>_geom eg "myanmar_flora_geom"	
	...
	'A survey of gibbons and other wildlife in the Bokeo section of Nam Kan National Protected Area, Lao PDR', --dataset_title - the publication name.  "Birds of Melanesia" should match providers.title and dashboard dataset.title
...
--delete from feature_metadata where data_table = 'namkan_birdsmammals' and title = 'Species name'

--Species Name field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'namkan_birdsmammals', --data_table - the name of the species list table. should match data_registry.table_name
...
-- delete from feature_metadata where data_table = 'namkan_birdsmammals' and title = 'Source'
-- Source field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'namkan_birdsmammals', --data_table - the name of the species list table. should match data_registry.table_name
	'timmins', --provider - the id of the provider.  should match providers.provider
	'''A survey of gibbons and other wildlife in the Bokeo section of Nam Kan National Protected Area, Lao PDR''', --field - the name of the field to be displayed from the data_table
...
-- delete from feature_metadata where data_table = 'namkan_birdsmammals' and title = 'Provider'
-- Provider field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'namkan_birdsmammals', --data_table - the name of the species list table. should match data_registry.table_name
	'timmins', --provider - the id of the provider.  should match providers.provider
	'''Timmins, 2013''', --field - the name of the field to be displayed from the data_table
...
-- delete from feature_metadata where data_table = 'namkan_birdsmammals' and title = 'URL'
-- URL field
insert into feature_metadata
	(data_table,provider,field,title,"order","type") --order and type are keywords so need to be in quotes
values (
	'namkan_birdsmammals', --data_table - the name of the species list table. should match data_registry.table_name
	'timmins', --provider - the id of the provider.  should match providers.provider
	'''<a target=''''_blank'''' onclick=''''window.open(this.href)'''' href=''''http://www.fauna-flora.org/wp-content/uploads/Nam-Kan-Gibbon-Survey-2012-18-May-2013.pdf''''>fauna-flora.org</a>''', --field - the name of the field to be displayed from the data_table
...
-- delete from feature_metadata where data_table = 'namkan_birdsmammals' and title = 'Type'
...
-- dashboard_metadata
--delete from dashboard_metadata where dataset_id = 'namkan_birdsmammals'
...
values (
	...
	'timmins', --provider
	'info@fauna-flora.org', --contact - email address of contact
	'Bokeo section of Nam Kan National Protected Area', --coverage - the geographic extent eg. "Global" or "Angola" or "New World"
	'namkan_birdsmammals', --dataset_id - the name of the species list table
	null, --date_more - null if not applicable
	'ca. 2012', --date_range - a string representation for the date range "ca. 1980 to 2010"
	'A survey of gibbons and other wildlife in the Bokeo section of Nam Kan National Protected Area, Lao PDR', --description - string description
	'Timmins, R. J. & Duckworth, J. W. 2012. A survey of gibbons and other wildlife in the Bokeo section of Nam Kan National Protected Area, Lao PDR. Fauna & Flora International, Cambridge, U.K.', --recommended_citation 
	...
	'http://www.fauna-flora.org/wp-content/uploads/Nam-Kan-Gibbon-Survey-2012-18-May-2013.pdf', --url - url of the datasource
