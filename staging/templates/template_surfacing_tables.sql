...
values (
	...
	'%cap_tax_class%', -- classes: same as taxa column, but capitalize
...
values (
	'%dataset_id%', --data_table - the name of the species list table. should match data_registry.table_name
	'''%cap_provider%, %pub_year%''', --field - the name of the field to be displayed from the data_table
...
values (
	'%dataset_id%', --data_table - the name of the species list table. should match data_registry.table_name
	'''<a target=''''_blank'''' onclick=''''window.open(this.href)'''' href=''''%full_url%''''>%short_url%</a>''', --field - the name of the field to be displayed from the data_table
